  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Tabs defaultValue="example1" className="space-y-4">
        <TabsList>
          <TabsTrigger value="example1">Basic Resource</TabsTrigger>
          <TabsTrigger value="example2">Course Example</TabsTrigger>
          <TabsTrigger value="example3">Learning Objective</TabsTrigger>
          <TabsTrigger value="example4">Assessment</TabsTrigger>
        </TabsList>

        <TabsContent value="example1" className="mt-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-xl font-semibold mb-4">Example 1: Basic Resource (Textbook)</h2>
              <p className="mb-4">
  ...
  <div itemprop="author" itemscope itemtype="http://oerschema.org/Person">
    <span itemprop="name">Jane Doe</span>
        ...
        <TabsContent value="example2" className="mt-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-xl font-semibold mb-4">Example 2: Course Structure</h2>
              <p className="mb-4">
                An example of a Course with multiple CourseSections and associated materials.
              </p>
              <div className="bg-card border rounded-lg p-6 mb-4">
            ...
            <div>
              ...
              <div className="bg-muted p-4 rounded-lg overflow-auto max-h-80">
                <pre className="text-sm">
{`<div itemscope itemtype="http://oerschema.org/Course">
    ...
    <div itemprop="associatedMaterial" itemscope 
      ...
      <p itemprop="name">Python for Data Science Handbook</p>
        ...
        <TabsContent value="example3" className="mt-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-xl font-semibold mb-4">Example 3: Learning Objective</h2>
              <p className="mb-4">
                An example of defining learning objectives that can be associated with educational resources.
              </p>
              <div className="bg-card border rounded-lg p-6 mb-4">
            ...
            <div>
              ...
              <div className="bg-muted p-4 rounded-lg overflow-auto max-h-80">
                <pre className="text-sm">
{`<div itemscope itemtype="http://oerschema.org/LearningObjective">
  ...
  <div>
    ...
    <link itemprop="action" href="http://oerschema.org/Making" />
        ...
        <TabsContent value="example4" className="mt-6">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-xl font-semibold mb-4">Example 4: Assessment Component</h2>
              <p className="mb-4">
                An example of an Assessment that demonstrates using more complex nested schema structures.
              </p>
              <div className="bg-card border rounded-lg p-6 mb-4">
            ...
            <div>
              ...
              <div className="bg-muted p-4 rounded-lg overflow-auto max-h-80">
                <pre className="text-sm">
{`<div itemscope itemtype="http://oerschema.org/Assessment">
